...
<main>
    ...
    <section class="main-section">
        ...
        <div class="main-content">
            <div class="main-image">
                <img src="/Images/site/staticPages/LTW.png" alt="">
            </div>
            <div class="main-text">
    ...
    <section class="values-section">
        ...
        <div class="values-container">
            <?php drawValueCard("/Images/site/staticPages/target-icon.png", "Missão", "Conectar pessoas que precisam de serviços com profissionais qualificados, criando uma plataforma digital segura, eficiente e confiável que facilite o acesso a soluções práticas para o dia a dia, promovendo oportunidades de negócio e melhorando a qualidade de vida dos nossos utilizadores através da tecnologia.", false, []) ?>
            <?php drawValueCard("/Images/site/staticPages/eye-icon.png", "Visão", "Ser a principal plataforma de referência em Portugal para a contratação de serviços domésticos e profissionais, reconhecida pela sua inovação tecnológica, segurança e pela qualidade das conexões que estabelece entre utilizadores e prestadores de serviços, contribuindo para uma sociedade mais colaborativa e eficiente.", false, []) ?>
            <?php drawValueCard("/Images/site/staticPages/star-icon.png", "Valores", "", true, ["Inovação constante na experiência do utilizador", "Transparência em todas as transações", "Segurança e confiança como prioridades", "Qualidade nos serviços e na plataforma", "Responsabilidade social e sustentabilidade"]) ?>
        </div>
    </section>
    ...
    <section>
        ...
        <div class="team-container">
            <?php drawTeamMember("/Images/site/staticPages/avatar2.jpg", "João Sousa", "up202207285") ?>
